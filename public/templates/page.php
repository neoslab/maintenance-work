...
<body>
    <div id="wrapper">
        <div class="wrapper">
            ...
            <a href="<?php echo get_site_url(); ?>" class="refresh"><?php echo __('Refresh Page', 'wpdx'); ?></a>
        </div>
    </div>    
    <?php $year = date('Y'); ?>
    <div class="footer">
